...
class Ttrss_hatebu extends Plugin
{
    ...
    function hook_article_button($line)
    {
        ...
        return "<img src=\"plugins.local/ttrss_hatebu/hatebu.png\"
			class='tagsPic' style=\"cursor: pointer;\"
			onclick=\"Plugins.Hatebu.view($article_id)\"
			title='はてなブックマークのエントリーを見る'>";
    }
    ...
    function linkHttp($comment){
        return preg_replace('/https?:\/\/\S+\.\S+\/?[\w!?\/+\-_~=;.,*&@#$%()\'\[\]]?/', $this->generateLink('$0', '$0'), $comment);
    }
